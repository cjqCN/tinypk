...
public class SnowflakeIdWorker {
    ...
    private static final long instanceBits = 10L;

    private static final long maxInstanceId = -1L ^ (-1L << instanceBits);
     ...
     * 机器ID向左移12位
     */
    private static final long instanceIdShift = sequenceBits;

    /**
     * 时间截向左移22位(5+5+12)
     */
    private static final long timestampLeftShift = sequenceBits + instanceBits;
    ...
    public SnowflakeIdWorker(long instanceId) {
